...
const DB_ID_EXAMPLE = '5b50a76713ddf90af494de32';
...
describe('Users', () => {
  ...
  describe('#getUser', () => {
    it('Should throw an error when there is no matching user', async () => {
      await expectError(User.getUser, [DB_ID_EXAMPLE]);
    });
  ...
  describe('#removeUser', () => {
    it('Should throw an error when there is no user to remove', async () => {
      await expectError(User.removeUser, [DB_ID_EXAMPLE]);
    });
  ...
  describe.only('#discharge', () => {
    it('Should throw an error when there is no user to discharge', async () => {
      await expectError(User.discharge, [DB_ID_EXAMPLE]);
    });
