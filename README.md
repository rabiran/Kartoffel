...
| DELETE    	| /api/kartoffel/removeMembers      | Remove members from a kartoffel           | None (yet)              	| /api/kartoffel/removeMembers  |
...
| DELETE    	| /api/kartoffel/removeAdmins       | Remove admins from a kartoffel            | None (yet)              	| /api/kartoffel/removeAdmins   |
